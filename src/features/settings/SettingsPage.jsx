...
import { ArrowLeft, Download, Trash2, ShieldCheck, Sun, Moon } from 'lucide-react';
import { useSettings } from '../../hooks/useSettings';
import { useTheme } from '../../hooks/useTheme';
import { useFeedback } from '../../components/Feedback';
import { saveSettings, setTabEnabled, TOGGLEABLE_TABS } from '../../data/settings';
import { CURRENCIES } from '../../lib/currency';
import { exportBackup, downloadJSON, clearAllData } from '../../data/admin';
      ...
      <section className="card-pad space-y-3">
        <div className="flex items-start gap-2">
          ...
          <p className="text-sm text-muted">
            Sonder is <span className="font-semibold text-ink">100% on this device</span>. No account, no servers, nothing leaves your phone. You own your data.
          </p>
        </div>
